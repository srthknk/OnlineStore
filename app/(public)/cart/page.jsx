                                ...
                                cartArray.map((item, index) => (
                                    <tr key={index} className="space-x-2">
                                        ...
                                        <td className="text-center max-md:hidden">
                                            <button onClick={() => handleDeleteItemFromCart(item.id, item.selectedSize)} className=" text-red-500 hover:bg-red-50 p-2.5 rounded-full active:scale-95 btn-animate btn-danger transition-all duration-300">
                                                <Trash2Icon size={18} />
                                            </button>
                                        </td>
                                    </tr>
