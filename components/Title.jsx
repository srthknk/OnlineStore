    ...
    return (
        <div className='flex flex-col items-center gap-2 sm:gap-3 md:gap-4'>
            ...
            <Link href={href} className='flex flex-col sm:flex-row items-center gap-2 sm:gap-3 md:gap-5 text-xs sm:text-sm text-slate-600 mt-1 sm:mt-2'>
                ...
                {visibleButton && <button className='text-green-500 flex items-center gap-1 whitespace-nowrap font-medium'>View more <FontAwesomeIcon icon={faArrowRight} className='text-sm' /></button>}
            </Link>
        </div>
    )
}
