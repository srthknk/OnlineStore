    ...
    return (
        <Link href={`/product/${product.id}`} className={`group max-xl:mx-auto w-full`}>
            ...
            <div className='flex flex-col gap-1.5 text-xs sm:text-sm text-slate-800 pt-3 w-full'>
                ...
                {/* Vegan Badge */}
                {product.isVegan && (
                    <div className='inline-flex items-center gap-1 w-fit px-2 py-1 bg-amber-50 rounded-full border border-amber-200'>
                        <FontAwesomeIcon icon={faLeaf} className='text-xs text-amber-700' />
