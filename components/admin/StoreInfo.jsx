...
const StoreInfo = ({store}) => {
    return (
        <div className="flex-1 space-y-2 text-sm">
            ...
            <p className="flex items-center gap-2"> <FontAwesomeIcon icon={faMapPin} className="text-sm" /> {store.address}</p>
            <p className="flex items-center gap-2"><FontAwesomeIcon icon={faPhone} className="text-sm" /> {store.contact}</p>
            <p className="flex items-center gap-2"><FontAwesomeIcon icon={faEnvelope} className="text-sm" />  {store.email}</p>
